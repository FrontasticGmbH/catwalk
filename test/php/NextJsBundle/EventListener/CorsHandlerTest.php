...
class CorsHandlerTest extends TestCase
{
    ...
    private function getFakePreflightRequest()
    {
        ...
        $request->headers->set('Access-Control-Request-Headers', 'Origin, Content-Type, Accept, Cookie, Frontastic-Currency, Frontastic-Locale, Frontastic-Path, Frontastic-Session, X-Frontastic-Access-Token, coFE-Custom-Configuration, Commercetools-Frontend-Extension-Version');
    ...
    public function testOnKernelRequestSetsCorrectHeaders()
    {
        ...
        $this->assertEquals(
            'Origin, Content-Type, Accept, Cookie, Frontastic-Session, X-Frontastic-Access-Token, Frontastic-Currency, Frontastic-Locale, Frontastic-Path, coFE-Custom-Configuration, Commercetools-Frontend-Extension-Version',
    ...
    public function testOnKernelResponseSetsCorrectHeaders()
    {
        ...
        $this->assertEquals(
            'Origin, Content-Type, Accept, Cookie, Frontastic-Currency, Frontastic-Locale, Frontastic-Path, Frontastic-Session, X-Frontastic-Access-Token, coFE-Custom-Configuration, Commercetools-Frontend-Extension-Version',
            $headers->get('Access-Control-Allow-Headers')
        );
        $this->assertEquals(
            '*, Authorization, Frontastic-Currency, Frontastic-Locale, Frontastic-Path, Frontastic-Session, X-Frontastic-Access-Token, coFE-Custom-Configuration, Commercetools-Frontend-Extension-Version',
