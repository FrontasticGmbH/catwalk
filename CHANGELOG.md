...
* misc: Tagged release “1.20.0” for catwalk
...
* misc: Tagged release 1.19.2 for catwalk
* fix: Only run 64 not 1000 curl processes in parallel for kameleoon reporting
* misc: Tagged release 1.19.1 for catwalk
* Merge branch 'master' of https://github.com/FrontasticGmbH/frontastic
* fix: ComponentInjector overrides regex not recognising all string formats
* misc: Tagged release 1.19.0 for catwalk
* fix: Tests.
* feat: Also complete node configuration for Next.js.
* fix: Type information on Request::query.
* misc: Tagged release 1.18.1 for catwalk
* fix: remove deviceType desktop flash on phone due to RegExp bug on UserAgent string
* Revert "Delivier assets during a roll out" – was not suposed to be merged
* Delivier assets during a roll out
* misc: Tagged release 1.18.0 for catwalk
* fix: set header type on nextjs Action Controller response
* feat(FP-953): Add name to PageFolder representations.
* misc: Tagged release 1.17.1 for catwalk
* fix(FP-926): Error page data is not filtered by JsonSerializer.
* fix(catwalk): move also dependencies of nextjs types
* chore(catwalk): move nextjs type conversion into saas
* feat(catwalk): Improve error message for nextjs change check
* feat(catwalk): check if nextjs types changed and stop build
* chore(catwalk): remove obsolete nextjs type conversion script
* chore(catwalk): update nextjs api types
* feat(catwalk): add another type annotation to nextjs api
* feat(catwalk): clean up type annotation for nextjs bundle
* feat(catwalk): generate typescript types from nextjs bundle API (WIP)
* misc: Tagged release 1.17.0 for catwalk
* fix: Do not remove tastic prop for translatable tastics
* chore(fp-935-polish): CS.
...
* Merge branch 'master' into update-kameleoon
* misc: Tagged release 1.16.0 for catwalk
* Merge branch 'master' into feat/FP-932-Algolia-implementation
* misc: Tagged release 1.15.3 for catwalk
* fix: wrap response in array only when there is actions
* feat: replace old files, add newest version
* fix: Custom Data Source removed environments, undeleted filter, cleanup on Gateway
* Merge branch 'master' into jim/replicate-custom-data-source
* fix: CustomDataSource and Facet refactor to use the UserBundle MetaData object
* misc: Tagged release 1.15.2 for catwalk
...
* misc: Tagged release 1.15.1 for catwalk
* Fixed incorrect webpack config schema
* Added missing CssMinimizerPlugin import
* Added TerserPlugin for JS minification in server production build
* Added TerserPlugin for JS minification in browser production build
* misc: Tagged release 1.15.0 for catwalk
...
* feat: Make registration of data sources from extensions work.
* fix: Mapping of non-object array values.
* fix: Map array properties to Next.js API models.
* fix: CS.
* fix: Duplicate route.
* feat: Command to dump registered hooks from within catwalk.
* fix: CS.
* feat(action-ctrl): Controller to retrieve project configuration.
* feat(action-ctrl): Docs.
* feat(action-ctrl): Proper routing for Frontastic Next.js controllers.
* feat(action-ctrl): Controller for retrieving page data.
* feat(action-ctrl): Extracted RouteService as an interface and override it.
* feat(action-ctrl): Service to match a PageFolder by slug (without real router).
* feat(action-ctrl): Require vsfStream for testing.
* feat(action-ctrl): Fixed missing imports.
* feat(action-ctrl): Fixed imports.
* feat(action-ctrl): Moved LayoutElement to Api namespace.
* feat(action-ctrl): Fixed namespace.
* feat(action-ctrl): Moved API related classes to dedicated namespace.
* misc: Tagged release 1.14.2 for catwalk
* misc: Tagged release 1.14.1 for catwalk
...
* fix: CustomDataSource minor fixes in the fill function and entity type
* Added types and description for link packages, minor refactor
* fix: CustomDataSource query fix the path for the entity
* fix: Only try linking when package is actually installed
* fix: CustomDataSource gateway fix the couch.db usage to doctine and the types in the doctrine schema
* fix: fix typo
* fix: CustomDataSource schema fixes
* fix: CustomDataSource fix the domain on CustomDataSourceService in catwalk
* feat: custom data source moved gateway, entity model from backstage to catwalk FrontendBundle
* feat: CustomDataSource replicator, service, schema, doctrine, latest function
* misc: Tagged release 1.14.0 for catwalk
...
* misc: Tagged release 1.13.0 for catwalk
* feat: Moving our concept of decorators to frontastic 1.5
* Changed confusing comment re: moment.js
* Revert "TO REVERT: test changes to test component injector rework"
* Added production differences to dependencies
...
* ComponentInjector: start of build modifications to exclude overridden components
* misc: Tagged release 1.12.8 for catwalk
* fix: Move NextJsBundle to correct component.
* misc: Tagged release 1.12.7 for catwalk
...
* TO REVERT: test changes to test component injector rework
* misc: Tagged release 1.12.6 for catwalk
* misc: Tagged release 1.12.5 for catwalk
* fix: issue with SSR because polyfill for date missing on window in react development scheduler implementation
* misc: Tagged release 1.12.4 for catwalk
* fix: translation typo
* misc: Tagged release 1.12.3 for catwalk
* preview fix
* Merge branch 'master' of github.com:FrontasticGmbH/frontastic
...
* misc: Tagged release 1.12.1 for catwalk
* fix: restored string replacement on product url generation
* Merge branch 'master' of github.com:FrontasticGmbH/frontastic
* misc: Tagged release 1.12.0 for catwalk
* Merge branch 'master' into kore/kameleoon-no-bots
* feat: Do not track bot actions
* chore(singleServer): updates to config based on testing
* misc: Tagged release 1.11.0 for catwalk
* fix(FP-736): set session samesite as non Only available from Symfony 4.3
* chore(FP-345): included comment on special JsonSerializer instance
* Merge remote-tracking branch 'origin/master' into james/node-single-server
* fix: Pass correct arguments
* Merge branch 'master' into kore/kameleoon-multiple-goals
...
* misc: Tagged release 1.10.15 for catwalk
* chore(catwalk): downgraded css minifier plugin for better node compatability
* chore(catwalk): added css-minimizer-webpack-plugin
* feat(FP-345): included new instance of JsonSerializer without enhancers
* fix(FP-729): extracted update cart logic and use it on checkout action
* feat(FP-345): used constants to call router hooks
* feat(FP-345): implemented hooks for Content Router
* feat(FP-345): use base router methods if there are no hooks
* feat(FP-345): returned product id if exist on Product Router
* feat(FP-345): implemented hooks for Category Router
* misc: Tagged release 1.10.14 for catwalk
* feat(FP-345): implemented hooks for Product Router
* fix: used column name to search hooks
* Merge branch 'master' into feat/config_master_page_routes
...
* chore(singleServer): adding missing template files, fixed port error
* Merge remote-tracking branch 'origin/master' into james/node-single-server
* chore(FP-345): improved Master route field docs
* misc: Tagged release 1.10.13 for catwalk
...
* chore(single SSR server): modifications after release
* misc: Tagged release 1.10.12 for catwalk
* introduced states and provinces
* misc: Tagged release 1.10.11 for catwalk
* chore(catwalk): removed TODOs on public files
* added missing comma
* added style propertly to SSR return
* misc: Tagged release 1.10.10 for catwalk
* feat: session delete argument, improvements, time check on chunk delete for recently updated sessions
* chore(catwalk): modify server_start to error if nodemon is not installed
* feat: First take on cron job to delete sessions
...
* misc: Tagged release 1.10.9 for catwalk
* fix(FP-703): implemented redirection on category routering
* chore(single SSR server): runtime error, can't find tastics in demo/src/js/singleServer
* chore(single SSR server): fixed eslint error
* chore(single SSR server): fixed eslint errors
* chore(single SSR server): fixed syntax error
* chore(single SSR server): added development bits, fix issue is paths.js
* chore(single SSR server): continuing implementation
* Merge remote-tracking branch 'origin/master' into james/test-node-multi-server
* misc: Tagged release 1.10.8 for catwalk
* fix: Fix the ContentController to use Context in viewAction
* misc: Tagged release 1.10.7 for catwalk
* refresh store after account information is changed
* Merge remote-tracking branch 'origin/master' into james/test-node-multi-server
* Merge branch 'master' of github.com:FrontasticGmbH/frontastic
* misc: Tagged release 1.10.6 for catwalk
* Merge branch 'master' into klaudija/term
* fix(FP-345): removed extra slash on Product router added for testing
* feat(FP-345): handled exception if project file not found from catwalk context
* feat(FP-345): checked if project file exist before load it
* feat(FP-345): used project and limit configurable fields on master routes
* feat(FP-345): extracted master routes definition to dedicated file
* Merge branch 'master' into sanja/terminology+brushups
* fix: update user context after address, user details, password changes
* chore(webpack): added SINGLE_SERVER prop to webpack.js
* Merge remote-tracking branch 'origin/master' into james/test-node-multi-server
* chore(catwalk): force mime dependency resolvutions to v1
* Merge branch 'master' into sanja/select-onload
* misc: Tagged release 1.10.5 for catwalk
* fix: used correct product service on Product Category Controller
* feat(backstage): more copy changes
* feat(backstage): more copy changes
* misc: Tagged release 1.10.4 for catwalk
* chore(FP-345): validated materRoutes param before access it on project config
* feat(FP-335): exposed MasterPage route difinition through project.yml
* chore(FP-91) Revert CartApiController is used by AdyenController too, refactored AdyenController
* chore(single SSR server): changed names of files
* .
...
* Merge branch 'master' into cli-tui-newy
* chore(FP-91) add the dependencies on the preview controller
* chore(FP-91) cleanup uncessary includes of AbstractController
* refactor(FP-91) abstract controllers refactoring paas common and frontend bundle #2
* misc: Tagged release 1.10.3 for catwalk
* fix: removed extra logs in catwalk CHANGELOG
* misc: Tagged release 1.10.2 for catwalk
* misc: Tagged release 1.10.1 for catwalk
* refactor(FP-91) frontend bundle to use abstract controllers
...
* misc: Tagged release 1.10.0 for catwalk
...
* misc: Tagged release 1.9.18 for catwalk
* fix: wrapped custom fields action in an array
* misc: Tagged release 1.9.17 for catwalk
* fix: Ignore annotations for Symfony
* misc: Tagged release 1.9.16 for catwalk
...
* misc: Tagged release 1.9.11 for catwalk
* added checkout translations
* renamed next:payment to order now
* misc: Tagged release 1.9.10 for catwalk
* fix: Work with babel 7.13.* by also processing .mjs files
* feat: New session handler that produces fewer db writes
