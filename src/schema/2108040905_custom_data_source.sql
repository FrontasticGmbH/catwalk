 CREATE TABLE custom_data_source (
    ...
    c_configuration_schema varchar(255) longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
    ...
    INDEX IDX_56B9BA28A6096BE1 (c_id),
    INDEX IDX_56B9BA28A53C9AA4 (c_sequence),
    PRIMARY KEY(c_id)
