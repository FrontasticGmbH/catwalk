let Locale = function (localeString) {
    ...
    this.guessTerritory = function (language) {
        return LANGUAGE_TO_TERRITORY[language.toLowerCase()] ?? language.toUpperCase()
    }
    ...
    this.guessCurrency = function (territory) {
        if (TERRITORY_TO_CURRENCY[territory]) {
            return TERRITORY_TO_CURRENCY[territory]
        }

        return DEFAULT_CURRENCY
    }

    this.guessCountry = function (territory) {
        if (TERRITORY_TO_COUNTRY[territory]) {
            return TERRITORY_TO_COUNTRY[territory]
        }
...
let Context = function (context = {}) {
    ...
    this.getCountry = function () {
        return this.parsedLocale.country
    }
