export default {
    ...
    checkout: {
        ...
        terms: 'AGB',
        cancelation: 'Widerrufsbelehrung',
        privacy: 'Datenschutzerklärung',
        policy1: 'Mit Klick auf „Fortfahren und bezahlen” stimme ich den ',
        policy2: ' zu. Ich habe die ',
        policy3: ' und die ',
        policy4: ' zur Kenntnis genommen.',
        yourOrderId: 'Bestellnummer: ',
        tryAgain: 'Erneut versuchen',
        backToShop: 'Zurück zum Shop',
        backToCart: 'Zurück zum Warenkorb',
        nextPayment: 'Fortfahren und bezahlen',
        nextOverview: 'Weiter zur Übersicht',
